...
public class A4IPConfigTextCalc extends BaseAttributeAccessor implements ConfigTextCalcInt{
	...
	public CBConfigText calculate(Element cb) throws Exception {
		...
		switch(z) {
		case 0x0000: val = pval;						break;
		case 0x0001: val = qval;						break;
		case 0x0002: val = cplxPval + "+" + cplxQval;	break;
		case 0x0003: val = cplxPval + "-" + cplxQval;	break;
		case 0x0004: val = cplxPval + "*" + cplxQval;	break;
		case 0x0005: val = cplxPval + "/" + cplxQval;	break;
		}
	...
	private String evalP(int ival) {
		switch(ival) {
			case 0x0000:	return "A";
			case 0x1000:	return "B";
			case 0x1040:	return "K1";
	...
	private String evalQ(int ival) {
		switch(ival) {
			case 0x0000:	return "C";
			case 0x0100:	return "D";
			case 0x0140:	return "K1";
