...
import com.cs.fwk.core.marketsim.BasicEventFeed;
...
public abstract class MatSystem implements SystemServicesInt {
	...
	protected void init(String propsResource, String hwIPAddr, int hwPortNum) throws Exception {
		...
		if (System.getProperty("sim") != null) {
			sim = loadMatSim("MatSim",new MatLogger() {
				@Override
	 ...
	 */
	private MatSimInt loadMatSim(String name, MatLogger logger, SystemServicesInt services) throws Exception {
