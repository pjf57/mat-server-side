...
public class MACDTest extends SimTestCase {
	...
	public void testEventFlow() throws Exception {
		MACD el = new MACD(1,this);
		el.putConfig(new ConfigItem(1, MatElementDefs.EL_MACD_C_FS_ALPHA, 0.5f));
		el.putConfig(new ConfigItem(1, MatElementDefs.EL_MACD_C_FS_LEN, 3));
		el.putConfig(new ConfigItem(1, MatElementDefs.EL_MACD_C_SL_ALPHA, 0.4f));
		el.putConfig(new ConfigItem(1, MatElementDefs.EL_MACD_C_SL_LEN, 4));
		el.putConfig(new ConfigItem(1, MatElementDefs.EL_MACD_C_SG_ALPHA, 0.5f));
		el.putConfig(new ConfigItem(1, MatElementDefs.EL_MACD_C_SG_LEN, 3));
		el.putConfig(new ConfigItem(1, MatElementDefs.EL_MACD_C_SET_OP, 2));
		el.putConfig(new ConfigItem(1, MatElementDefs.EL_C_SRC_ROUTE,2,1));
		el.putConfig(new ConfigItem(1, MatElementDefs.EL_C_CFG_DONE,0));
